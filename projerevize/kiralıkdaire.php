...
$sql = "SELECT adverts.*, users.user_id, users.name 
        FROM adverts 
        INNER JOIN users ON adverts.user_id = users.user_id WHERE properties_type='$type' AND sale_status='$status'";
...
<section class="listings">
   ...
   <h1 class="heading">Kiralık Daireler</h1>

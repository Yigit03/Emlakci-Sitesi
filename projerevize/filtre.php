...
// SQL sorgusu oluştur
$sql = "SELECT adverts.*, users.user_id, users.name 
        FROM adverts 
        INNER JOIN users ON adverts.user_id = users.user_id WHERE city='$city' AND properties_type='$type' AND rooms='$bhk' AND price BETWEEN '$minimum' AND '$maximum'";
...
<section class="listings">
   ...
   <h1 class="heading">Tüm Listelemeler</h1>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") 
{
    ...
    {
        echo '<div class="box" text-align="center" style="margin:189px 0px 189px 0px;">';     
        echo  '<h3 class="name" style="margin-left:30px;">İstenilen Özelliklerde İlan <br ></h3>';
        echo '<h3 class="name" style="margin-left:70px;">Bulunamamıştır.</h3>';
        echo "</div>";
    }
...
<!-- <div class="box-container">
      ...
      <div class="box">
         ...
         <div class="thumb">
            ...
            <p class="type"><span>Ev</span><span>Satılık</span></p>
            <form action="" method="post" class="save">
               <button type="submit" name="save" class="far fa-heart"></button>
            </form>
            <img src="images/house-img-1.webp" alt="">
         </div>
         <h3 class="name">Modern Daire ve Apartman</h3>
         <p class="location"><i class="fas fa-map-marker-alt"></i><span>Kahramanlar,Konak,İzmir - 35000</span></p>
         <div class="flex">
            <p><i class="fas fa-bed"></i><span>4</span></p>
            <p><i class="fas fa-bath"></i><span>2</span></p>
            <p><i class="fas fa-maximize"></i><span>350m²</span></p>
         </div>
         <a href="view_property.php" class="btn">Tüm Özellikleri Göster</a>
      </div>
      ...
      <div class="box">
         ...
         <div class="thumb">
            <p class="total-images"><i class="far fa-image"></i><span>4</span></p>
            <p class="type"><span>Daire</span><span>Satılık</span></p>
            <form action="" method="post" class="save">
               <button type="submit" name="save" class="far fa-heart"></button>
            </form>
            <img src="images/house-img-2.webp" alt="">
         </div>
         <h3 class="name">Sahibinden Masrafsız Kiralık</h3>
         <p class="location"><i class="fas fa-map-marker-alt"></i><span>7 eylül,ivrindi,Balıkesir - 10000</span></p>
         <div class="flex">
            <p><i class="fas fa-bed"></i><span>3</span></p>
            <p><i class="fas fa-bath"></i><span>1</span></p>
            <p><i class="fas fa-maximize"></i><span>110m²</span></p>
         </div>
         <a href="view_property.php" class="btn">Tüm Özellikleri Göster</a>
      </div>
      ...
      <div class="box">
         ...
         <div class="thumb">
            <p class="total-images"><i class="far fa-image"></i><span>4</span></p>
            <p class="type"><span>Daire</span><span>Kiralık</span></p>
            <form action="" method="post" class="save">
               <button type="submit" name="save" class="far fa-heart"></button>
            </form>
            <img src="images/house-img-3.jpg" alt="">
         </div>
         <h3 class="name">Yeni Bina Yapılı Daire</h3>
         <p class="location"><i class="fas fa-map-marker-alt"></i><span>konum Belirtilmemiş !</span></p>
         <div class="flex">
            <p><i class="fas fa-bed"></i><span>2</span></p>
            <p><i class="fas fa-bath"></i><span>1</span></p>
            <p><i class="fas fa-maximize"></i><span>98m²</span></p>
         </div>
         <a href="view_property.php" class="btn">Tüm Özellikleri Göster</a>
      </div>
      ...
      <div class="box">
         ...
         <h3 class="name">Öğrenciye Kiralık (şaka :| )</h3>
         <p class="location"><i class="fas fa-map-marker-alt"></i><span>erzene,bornova,İzmir - 10000</span></p>
         <div class="flex">
            <p><i class="fas fa-bed"></i><span>2</span></p>
            <p><i class="fas fa-bath"></i><span>1</span></p>
            <p><i class="fas fa-maximize"></i><span>90m²</span></p>
         </div>
         <a href="view_property.php" class="btn">Tüm Özellikleri Göster</a>
      </div>
      ...
      <div class="box">
         ...
         <h3 class="name">Modern Rezidans Dairesi</h3>
         <p class="location"><i class="fas fa-map-marker-alt"></i><span>korucu,ivrindi,Balıkesir - 10000</span></p>
         <div class="flex">
            <p><i class="fas fa-bed"></i><span>4</span></p>
            <p><i class="fas fa-bath"></i><span>1</span></p>
            <p><i class="fas fa-maximize"></i><span>120m²</span></p>
         </div>
         <a href="view_property.php" class="btn">Tüm Özellikleri Göster</a>
      </div>
      ...
      <div class="box">
         ...
         <div class="thumb">
            <p class="total-images"><i class="far fa-image"></i><span>4</span></p>
            <p class="type"><span>Ev (Bina)</span><span>Satılık</span></p>
            <form action="" method="post" class="save">
               <button type="submit" name="save" class="far fa-heart"></button>
            </form>
            <img src="images/house-img-6.webp" alt="">
         </div>
         <h3 class="name">Sahibinden orta yaşlı daire</h3>
         <p class="location"><i class="fas fa-map-marker-alt"></i><span>alsancak,konak,İzmir - 35000</span></p>
         <div class="flex">
            <p><i class="fas fa-bed"></i><span>4</span></p>
            <p><i class="fas fa-bath"></i><span>2</span></p>
            <p><i class="fas fa-maximize"></i><span>132m²</span></p>
         </div> -->
</section>
